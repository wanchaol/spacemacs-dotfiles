...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(
                                    helm-flyspell flyspell-correct-helm ac-ispell vi-tilde-fringe
                                   )
...
`dotspacemacs/user-config' first."
  ...
  ;; resolve the hanging issue when starting up, as suggested by FAQ
...
you should place your code here."
  ...
  ;; For python underscore word motion
